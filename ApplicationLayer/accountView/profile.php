              ...
              <div class="my-4">
                ...
                <form method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="username" class="form-control" id="inputUsername" value="<?= $row['username'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="inputEmail4">Email</label>
                    <input type="email" name="email" class="form-control" id="inputEmail4" value="<?= $row['email'] ?>" disabled>
                  </div>
                  <div class="form-group">
                    <label for="inputEmail4">Phone</label>
                    <input type="text" name="phone" class="form-control" id="inputPhone" value="<?= $row['phone'] ?>">
                  </div>
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      <label for="inputLocation">Location</label>
                      <input type="text" name="state" class="form-control" id="inputLocation" value="<?= $row['state'] ?>">
                    </div>
                  </div>
                  <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure you want to update?');" name="update">Save Change</button>
                </form>
                <?php } ?>
              </div> <!-- /.card-body -->
            </div> <!-- /.col-12 -->
