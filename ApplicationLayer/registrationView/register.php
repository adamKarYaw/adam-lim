      ...
      <div class="row align-items-center h-100">
        ...
        <form method="POST" class="col-lg-3 col-md-4 col-10 mx-auto text-center">
          ...
          <div class="form-group">
            ...
            <input type="password" id="userPwd" name="userPwd" class="form-control form-control-lg" placeholder="Enter Password" required="">
          </div>
          <div class="form-group">
            <label for="inputPhone" class="sr-only">Phone</label>
            <input type="text" id="phone" name="phone" class="form-control form-control-lg" placeholder="Enter Phone" required="" autofocus="">
          </div>
          <div class="form-group">
            <label for="inputLocation" class="sr-only">Location</label>
            <input type="text" id="state" name="state" class="form-control form-control-lg" placeholder="Enter Phone" required="" autofocus="">
          </div>

          <button class="btn btn-lg btn-primary btn-block" type="submit" name="register">Sign Up</button>
          <div class="text-center mt-5 text-lg fs-4">
              <p class="text-gray-600">Already have an account? <a href="login.php"class="font-bold">Click Here</a>.</p>
              <p><a class="font-bold" href="forgetPassword.php">Forgot password?</a>.</p>
          </div>
          <p class="mt-5 mb-3 text-muted">© 2020</p>
        </form><!-- Form for Log In End-->
      </div>
    </div>
